...
type Verification struct {
	...
	Checks struct {
		...
		FaceComparison *Check `json:"face_comparison"`
		Poa            *Check `json:"poa"`
...
type Applicant struct {
	...
	SystemInfo                       *ApplicantInfo `json:"system_info"`
	ProvidedInfo                     *ApplicantInfo `json:"provided_info"`
...
type Check struct {
	Status           string   `json:"status"`
	PendingDocuments []string `json:"pending_documents"`
...
type Settings struct {
	...
	PoiAllowedDocuments                 []string `json:"poi_allowed_documents"`
	FaceComparisonRequired              bool     `json:"face_comparison_required"`
	FaceComparisonAllowedDocuments      []string `json:"face_comparison_allowed_documents"`
...
type DocumentUpload struct {
	...
	IssuedCountry *string   `json:"issued_country"`
	ApplicantID   string    `json:"applicant_id"`
