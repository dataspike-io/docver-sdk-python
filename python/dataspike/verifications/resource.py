...
class Verifications(Resource):
    ...
    def _create(self, checks_required: Sequence[DocumentType],
                applicant_id: Optional[UUID] = None) -> Response:
    ...
    @validate_arguments
    def create(self, checks_required: Sequence[DocumentType], applicant_id: Optional[UUID] = None) -> Verification:
